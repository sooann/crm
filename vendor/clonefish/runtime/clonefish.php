...
class clonefish {
   ...
   * @access public  
   */
  function clonefish( $name, $action, $method, $db = null, $dbtype = null, $refid = null ) {
   ...
   */
	...
	include_once( CLONEFISH_DIR . 'dbwrapper_propel.php');
  ...
  function addElements( $elements, $values = false, $slashes_added = null ) {
    ...
    foreach ( $elements as $key => $value ) {
      ...
      $classfile = 
        CLONEFISH_DIR . '../../../build/element/element.' . $elementtype . '.php';
      ...
      foreach ( $validationsettings as $vskey => $validationparameters ) {
        ...
        switch ( $validationparameters['type'] ) {
          ...
          default:
            ...
            $classfile = 
              CLONEFISH_DIR . '../../../build/validation/validation.' . strtolower( $validationparameters['type'] ) . '.php';
  ...
  function &_getRequiredClassFor( &$element, $validationparameters ) {
    ...
    $classfile   = '../../../build/validation/validation.required.' . $elementtype . '.php';
