...
class PropelPDO extends PDO
{
    ...
    /**
     * Start time of latest performed query.
     *
     * @var       string
     */
    protected $startTimeLastExecutedQuery;
	
    /**
     * End time of latest performed query.
     *
     * @var       string
     */
    protected $endTimeLastExecutedQuery;
    ...
    */
    ...
    /**
     * Get the Start Time for the latest query executed by Propel
     *
     * @return string Executable SQL code
     */
    public function getStartTimeLastExecutedQuery()
    {
        return $this->startTimelastExecutedQuery;
    }
	
    /**
     * Get the End Time for the latest query executed by Propel
     *
     * @return string Executable SQL code
     */
    public function getEndTimeLastExecutedQuery()
    {
        return $this->endTimelastExecutedQuery;
    }
    ...
    public function log($msg, $level = null, $methodName = null, array $debugSnapshot = null)
    {
		...
		// set start and end time of the sql logging
		$now = $this->getDebugSnapshot();
		$this->startTimelastExecutedQuery = date("Y-m-d H:i:s.u",$debugSnapshot['microtime']);
		$this->endTimelastExecutedQuery = date("Y-m-d H:i:s.u",$now['microtime']);
