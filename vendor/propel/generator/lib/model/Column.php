...
class Column extends XMLElement
{
    ...
    private $phpNamingMethod = PhpNameGenerator::CONV_METHOD_DATABASE;
    ...
    public static function generatePhpName($name, $phpNamingMethod = PhpNameGenerator::CONV_METHOD_DATABASE, $namePrefix = null)
    {
