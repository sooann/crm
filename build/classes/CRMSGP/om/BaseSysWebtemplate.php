...
abstract class BaseSysWebtemplate extends BaseObject implements Persistent
{
     ...
     * Otherwise if this SysWebtemplate is new, it will return
     * an empty collection; or if this SysWebtemplate has previously
     * been saved, it will retrieve related SysWebpages from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SysWebtemplate.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|SysWebpage[] List of SysWebpage objects
     */
    public function getSysWebpagesJoinSysSqlquery($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SysWebpageQuery::create(null, $criteria);
        $query->joinWith('SysSqlquery', $join_behavior);
